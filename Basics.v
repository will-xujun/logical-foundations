...
Proof.
  intros n m o. 
  intros H1. intros H2. rewrite -> H1,H2. reflexivity. Qed.
(** [] *)
...
Theorem mult_n_1 : forall p : nat,
  p * 1 = p.
Proof.
  intros p. rewrite <- mult_n_Sm. rewrite <- mult_n_O. reflexivity. Qed.
...
Theorem andb_true_elim : forall b: bool, true && b =b .
...
Proof.
  ...
  - intros H. rewrite <- H. rewrite andb_true_elim. reflexivity.
  - destruct c. + intros H1. reflexivity. + intros H2. rewrite <- H2. reflexivity. Qed. 
(** [] *)
