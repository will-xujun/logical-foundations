...
Check mult_n_Sm.
Theorem plus_O_comm: forall n: nat, n+0=n.
Proof. intros n. induction n as [|n' IHn'].
- reflexivity.
- simpl. rewrite IHn'. reflexivity. Qed.

Theorem one_plus_n_comm : forall n: nat, 1+n=n+1.
Proof. intros n. induction n as [|n' IHn'].
- reflexivity.
- simpl. rewrite <- IHn'. reflexivity. Qed.
...
- induction m as [|m' IHm']. 
  + rewrite <- one_plus_n_comm. simpl. rewrite plus_O_comm. reflexivity.
  + simpl. rewrite IHn'. reflexivity. Qed.

Theorem add_comm : forall n m : nat,
  n + m = m + n.
Proof. intros n m. induction n as [|n' IHn'].
- rewrite plus_O_comm. reflexivity.
...
Proof. intros n m. induction n as [|n' IHn'].
- induction m as [|m' IHm']. 
+ reflexivity. + rewrite mult_0_l. simpl. rewrite <- IHm'.
  reflexivity.
...
Theorem double_neg: forall b: bool, negb (negb b) = b.
Proof. intros b. destruct b. reflexivity. reflexivity. Qed.

Theorem even_SS: forall n: nat, even (S (S n))=even n.
Proof.
intros n. induction n as [|n' IHn'].
...
Proof.
  intros n. induction n as [|n' IHn'].
  - simpl. reflexivity.
  - induction n' as [|n2 IH2]. +reflexivity.
  + rewrite even_SS. rewrite IHn'. rewrite double_neg. reflexivity. Qed.
(** [] *)
