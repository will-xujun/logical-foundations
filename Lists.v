...
Fixpoint nonzeros (l:natlist) : natlist :=
  match l with
  |nil => nil
  |h::t => if h=? 0 then nonzeros t else nonzeros t
  end.
...
Proof.
  intros l1 l2. induction l1 as [|h t IH1].
  - simpl. reflexivity.
  - destruct h.
...
Proof.
 ...
 - reflexivity.
 - simpl. induction h as [|h']. + simpl. rewrite IHl. reflexivity.
...
Proof. intros l. destruct l as [].
  -reflexivity.
  -simpl. intros d. reflexivity. Qed.
...
Proof.
  intros x. destruct x. simpl. induction n as [|n']. -reflexivity. -simpl. rewrite IHn'. reflexivity.
  Qed. 
(** [] *)
...
Theorem n_equal_n_true : forall n:nat, n=?n =true.
Proof. intros n. induction n as [|n' ihn']. -reflexivity. 
-simpl. rewrite ihn'. reflexivity. Qed.
...
Proof.
  intros d x v. induction d as [|x1 v1 d' IH].
  - simpl. destruct x.
    simpl. rewrite n_equal_n_true. reflexivity.
  - simpl. destruct x. simpl. rewrite n_equal_n_true. reflexivity. Qed.
(** [] *)
...
Proof. intros d x y o. destruct d as [|key val d'].
